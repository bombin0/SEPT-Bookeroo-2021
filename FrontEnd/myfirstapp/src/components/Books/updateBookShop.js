...
class updateBook extends Component {
    constructor(props) {
        ...
        this.updateBookShop = this.updateBookShop.bind(this);
    }
    componentDidMount(){
    ...
    updateBookShop = (e) => {
        ...
        bookService.updateBookShop(book, this.state.id).then( res =>{
                            ...
                            <div className = "card col-md-6 offset-md-3 offset-md-3">
                                ...
                                <div className = "card-body">
                                    <form>
                                        ...
                                        <button className="btn btn-success" onClick={this.updateBookShop}>Save</button>
